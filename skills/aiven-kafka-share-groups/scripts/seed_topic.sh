...
JAR_PATH="$JAVA_DIR/target/kafka-share-groups-demo-1.0-SNAPSHOT-producer.jar"
...
echo "==> Seeding product_photo_raw with ${MESSAGE_COUNT} records..."
java -jar "$JAR_PATH" "$MESSAGE_COUNT"
